...
public class TestData {
    ...
    public static UserBookingDto userBookingDto2 = new UserBookingDto(2L, "TestUser2");
    public static UserAuthorDto userAuthorDto2 = new UserAuthorDto(2L, "TestUser2");
    public static UserRequestDto userRequestDto2 = new UserRequestDto(2L, "TestUser2", "user2@mail.ru");
    public static UserResponseDto userResponseDto2 = new UserResponseDto(2L, "TestUser2", "user2@mail.ru");


    public static User user3 = new User(3L, "TestUser3", "user3@mail.ru");
    ...
    public static RequestInputDto requestInputDto1 = new RequestInputDto(1L, "Test request description1",
            LocalDateTime.of(2025, 7, 7, 10, 15, 25));
    public static RequestOutputDto requestOutputDto1 = new RequestOutputDto(1L, "Test request description1", userBookingDto1,
            LocalDateTime.of(2025, 7, 7, 10, 15, 25));
    ...
    public static RequestInputDto requestInputDto2 = new RequestInputDto(2L, "Test request description2",
            LocalDateTime.of(2025, 8, 8, 15, 10, 20));
    public static RequestOutputDto requestOutputDto2 = new RequestOutputDto(2L, "Test request description2",
    ...
    public static ItemResponseDtoWithComments itemWithComments1 = new ItemResponseDtoWithComments(1L, "testItem1",
            "test description1", false, user1.getUserId(), request1.getItemRequestId(),
            new BookingResponseDto(), new BookingResponseDto(), new ArrayList<>());


    public static Item item2 = new Item(2L, "testItem2",
            "test description2", true, user2, request2);
    ...
    public static ItemResponseDtoWithComments itemWithComments2 = new ItemResponseDtoWithComments(2L,
            "testItem2", "test description2", true, user2.getUserId(), request2.getItemRequestId(),
            new BookingResponseDto(), new BookingResponseDto(), new ArrayList<>());
    ...
    public Collection<BookingResponseDto> bookingsForOwner = Arrays.asList(responseBooking1, responseBooking3, responseBooking4, responseBooking5);

    public static Comment comment1 = new Comment(1L, "Test comment text1", user1, item1);
